                ...
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="news-1.jpg" alt="blog"/>
                    <div className="p-6">
                      ...
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Full Web</h1>
                      <p className="leading-relaxed mb-3">blog, in full Web log or Weblog, online journal where an individual, group, or corporation presents a record of activities, thoughts, or beliefs. Some blogs operate mainly as news filters...</p>
