    ...
    <div className="-my-8 divide-y-2 divide-gray-100">
      <div className="py-8 flex flex-wrap md:flex-nowrap">
        ...
        <div className="md:flex-grow">
          <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">Web Development</h2>
          <p className="leading-relaxed">blog, in Web Development log or Weblog, online journal where an individual, group, or corporation presents a record of activities, thoughts, or beliefs. Some blogs operate mainly as news filters...</p>
          <Link href={'/blogpost/Web-Devlopment'}><a className="text-indigo-500 inline-flex items-center mt-4">Learn More
